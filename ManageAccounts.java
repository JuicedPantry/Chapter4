...
public class ManageAccounts
{
    public static void main(String[] args)
    {
        ...
        Account Joe = new Account(500, "Joe", 1112);
        ...
        System.out.println("Joe's final balance is: " + Joe.getBalance());
        System.out.println("Sally's final balance is: " + Sally.getBalance());
    }
}